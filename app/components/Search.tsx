  ...
  return (
        <form onSubmit={handleSubmit} method="post">
            <div className='text-3xl flex flex-col items-center'>
                ...
                <div>
                    <button className='my-4 font-bold border text-xl p-2 text-white transition ease-in-out delay-150 bg-slate-700 hover:bg-slate-900 duration-300 rounded-lg'>Rechercher</button>
                </div>
            </div>
        </form>
  )
